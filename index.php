...
<!-- Team Thumb-->
<div class="advisor_thumb"><a href="ELISE_STROMBERG.php"><img src="picture_for_class.jpg" alt="" style = 'height: auto; width: 100%; object-fit: contain'></a>
<!-- Social Info-->
<div class="social-info"><a href="ELISE_STROMBERG.php"><i class="fa fa-facebook"></i></a><a href="ELISE_STROMBERG.php"><i class="fa fa-twitter"></i></a><a href="ELISE_STROMBERG.php"><i class="fa fa-linkedin"></i></a></div>
</div>
<!-- Team Details-->

<div class="single_advisor_details_info">
    <?php
        echo '<h6>Elise Stromberg</h6>';


        echo '<p class="designation">Student at Northern Kentucky University</p>';
?>
